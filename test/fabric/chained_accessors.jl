...
add_fk!(fabric, wine_src, winemaker_src, :Wine!color => :Winemaker!Winemaker_id)
#
...
add_part!(fabric, :Food, comments="Should be a string")
...
@test subpart(fabric, [:maker, :country_code, :country]) == [:Antarctica]
